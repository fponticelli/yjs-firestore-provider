import { getFirestore, doc, setDoc, serverTimestamp, getDoc, deleteDoc, query as query$1, collection as collection$1, onSnapshot as onSnapshot$1, writeBatch, runTransaction, Bytes, getDocs } from '@firebase/firestore';
import * as Y from 'yjs';
import SimplePeer from 'simple-peer';
import * as awarenessProtocol from 'y-protocols/awareness';
import { getFirestore as getFirestore$1, collection, query, onSnapshot, deleteDoc as deleteDoc$1, serverTimestamp as serverTimestamp$1, getDoc as getDoc$1, doc as doc$1, Timestamp, setDoc as setDoc$1 } from 'firebase/firestore';
    ...
    handleUnresponsivePeer() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (signalingConn) {
                ...
                const announceRef = doc$1(db, announcePath);
                const list = [
                ...
                if (signals) {
                    signals.forEach(msgId => {
                        ...
                        const signalRef = doc$1(db, signalPath);
...
class FirestoreSignalingConn {
    ...
    deleteAnnounceDoc() {
        return __awaiter(this, void 0, void 0, function* () {
            const announcePath = this.getAnnouncePath();
            const db = getFirestore$1(this.firebaseApp);
            const ref = doc$1(db, announcePath);
